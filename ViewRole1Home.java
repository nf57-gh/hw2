...
public class ViewRole1Home {
	...
	protected static Button button_OpenForumApp = new Button("Open Forum App");
	...
	private ViewRole1Home() {
		...
		setupButtonUI(button_OpenForumApp, "Dialog", 18, 170, Pos.CENTER, 410, 45);
		button_OpenForumApp.setOnAction((event) ->
			{Main main = new Main();
			main.openInNewWindow();});
		...
		// Place all of the widget items into the Root Pane's list of children
         theRootPane.getChildren().addAll(
			label_PageTitle, label_UserDetails, button_UpdateThisUser, button_OpenForumApp, line_Separator1,
